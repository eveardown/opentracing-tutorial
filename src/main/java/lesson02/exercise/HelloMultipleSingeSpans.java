 ...
 *
 * <p>This example is based on {@link lesson01.exercise.HelloSingleSpanRealTracer}, with the following changes:</p>
 *
 * <ul>
 ...
 * </ul>
 *
 * The running requirements are the same as those for {@link lesson01.exercise.HelloSingleSpanRealTracer}.
 *
...
public class HelloMultipleSingeSpans {
     ...
     *          The tracer to use.
     */
    private HelloMultipleSingeSpans(final io.opentracing.Tracer theTracer) {
        tracer = theTracer;
    }
